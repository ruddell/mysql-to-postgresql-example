...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "travisMysql@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "travisMysql API";

        private String description = "travisMysql API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "travisMysql";
